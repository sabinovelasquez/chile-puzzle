...
**ES**
- Compartir ahora da una recompensa única de +50 pts por ubicación, sin importar la dificultad. Una vez compartida, la recompensa se cierra para esa ubicación.

**EN**
- Sharing now grants a one-time +50 pts per location, regardless of difficulty. Once shared, the reward closes for that location.
